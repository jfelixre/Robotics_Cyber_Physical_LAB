...
#include "interfaces/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
using _RobotState__ros_msg_type = interfaces__msg__RobotState;
...
size_t get_serialized_size_interfaces__msg__RobotState(
  const void * untyped_ros_message,
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__RobotState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__RobotState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__msg__RobotState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, RobotState)() {
