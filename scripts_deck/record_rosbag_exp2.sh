...
# Script to record EXPERIMENT 2 rosbag data
# Usage: ./record_rosbag_exp2.sh
# 
# Run this AFTER launching experiment 2 with:
...
echo "🎬 Starting rosbag recording for EXPERIMENT 2"
...
if [ $NUM_TOPICS -eq 0 ]; then
    echo "❌ No topics found! Make sure experiment 2 is running."
    echo "💡 Launch with: ros2 launch launch_pkg gazebo_sim_exp_2.launch.py"
    exit 1
fi
...
cleanup() {
    ...
    echo "🏁 Experiment 2 recording completed!"
