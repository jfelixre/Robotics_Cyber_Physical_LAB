...
# Script to record EXPERIMENT 1 rosbag data
# Usage: ./record_rosbag_exp1.sh
# 
# Run this AFTER launching experiment 1 with:
...
echo "🎬 Starting rosbag recording for EXPERIMENT 1"
echo "🤖 Expected robots: robot_01, robot_02" 
...
if [ $NUM_TOPICS -eq 0 ]; then
    echo "❌ No topics found! Make sure experiment 1 is running."
    echo "💡 Launch with: ros2 launch launch_pkg gazebo_sim_exp_1.launch.py"
    exit 1
fi
...
cleanup() {
    ...
    echo "🏁 Experiment 1 recording completed!"
