...
#ifndef INTERFACES__SRV__DETAIL__CONTROL_PID_START__FUNCTIONS_H_
#define INTERFACES__SRV__DETAIL__CONTROL_PID_START__FUNCTIONS_H_
...
/// Initialize srv/ControlPidStart message.
/**
...
/// Finalize srv/ControlPidStart message.
/**
...
/// Create srv/ControlPidStart message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces__srv__ControlPidStart_Request__init().
...
/// Destroy srv/ControlPidStart message.
/**
 * It calls
 * interfaces__srv__ControlPidStart_Request__fini()
...
/// Initialize array of srv/ControlPidStart messages.
/**
...
/// Finalize array of srv/ControlPidStart messages.
/**
 * It calls
 * interfaces__srv__ControlPidStart_Request__fini()
...
/// Create array of srv/ControlPidStart messages.
/**
 * It allocates the memory for the array and calls
 * interfaces__srv__ControlPidStart_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ControlPidStart messages.
/**
 * It calls
 * interfaces__srv__ControlPidStart_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces__srv__ControlPidStart_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__ControlPidStart_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It allocates the memory for the array and calls
 * interfaces__srv__ControlPidStart_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__ControlPidStart_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACES__SRV__DETAIL__CONTROL_PID_START__FUNCTIONS_H_
