...
#include <stddef.h>
#include "interfaces/msg/detail/robot_state__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember RobotState__rosidl_typesupport_introspection_c__RobotState_message_member_array[1] = {
  {
    ...
    offsetof(interfaces__msg__RobotState, robot_state),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotState__rosidl_typesupport_introspection_c__RobotState_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces__msg__RobotState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, msg, RobotState)() {
