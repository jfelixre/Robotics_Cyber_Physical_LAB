...
def generate_launch_description():
    ...
    # ---------------------------------------------------------
    # 9. DATA LOGGING - MOVIDO AL LAUNCH DEL EXPERIMENTO
    # ---------------------------------------------------------
    # data_logger = Node(
    #     package='control_pkg',
    #     executable='robot_data_logger.py',
    #     name='robot_01_data_logger',
    #     parameters=[{
    #         'experiment_name': 'multi_robot_exp',
    #         'robots': 3,  # 🔧 CAMBIO: Manejar 3 robots desde robot 1
    #         'robot_offset': 1,
    ...
    return LaunchDescription([
        ...
        # Data Logging - MOVIDO AL LAUNCH DEL EXPERIMENTO
        # data_logger,
    ])