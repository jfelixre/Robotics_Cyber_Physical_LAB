...
def generate_launch_description():
    ...
    print("\n" + "="*60)
    print("🎯 EXPERIMENTO 3 - ADVANCED SIMULATION")
    print("="*60)
    print("💡 Para grabar rosbag: ./scripts_deck/record_rosbag.sh experiment_3")
    print("📊 Para gráficas después: python3 plot_trajectories_professional.py --experiment experiment_3 --legacy --errors --robots NUM")
    print("="*60)
    print("="*60 + "\n")
    ...
    # ros2 launch launch_pkg robot_03_sim.launch.py experiment_timestamp:=TIMESTAMP
