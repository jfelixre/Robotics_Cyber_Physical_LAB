...
CMakeFiles/img_proc_id_node.dir/src/img_proc_id_node.cpp.o: ../../src/img_proc_id_node.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/img_proc_id_node.dir/src/img_proc_id_node.cpp.o"
...
img_proc_id_node: /usr/local/lib/libopencv_gapi.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_stitching.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_aruco.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_barcode.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_bgsegm.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_bioinspired.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_ccalib.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_dnn_objdetect.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_dnn_superres.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_dpm.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_face.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_freetype.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_fuzzy.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_hdf.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_hfs.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_img_hash.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_intensity_transform.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_line_descriptor.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_mcc.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_quality.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_rapid.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_reg.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_rgbd.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_saliency.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_stereo.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_structured_light.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_superres.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_surface_matching.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_tracking.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_videostab.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_wechat_qrcode.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_xfeatures2d.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_xobjdetect.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_xphoto.so.4.7.0
...
img_proc_id_node: /opt/ros/foxy/lib/librmw_fastrtps_cpp.so
...
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_generator_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_introspection_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_introspection_cpp.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_cpp.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common.so
...
img_proc_id_node: /opt/ros/foxy/lib/librmw_fastrtps_shared_cpp.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_introspection_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_generator_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_c.so
img_proc_id_node: /opt/ros/foxy/lib/librmw_dds_common__rosidl_typesupport_introspection_cpp.so
...
img_proc_id_node: /opt/ros/foxy/lib/librosidl_typesupport_fastrtps_c.so
img_proc_id_node: /opt/ros/foxy/lib/librosidl_typesupport_fastrtps_cpp.so
img_proc_id_node: /opt/ros/foxy/lib/librosidl_typesupport_fastrtps_cpp.so
img_proc_id_node: /opt/ros/foxy/lib/libfastrtps.so.2.1.4
img_proc_id_node: /opt/ros/foxy/lib/libfoonathan_memory-0.7.1.a
img_proc_id_node: /usr/lib/x86_64-linux-gnu/libtinyxml2.so
img_proc_id_node: /opt/ros/foxy/lib/libfastcdr.so.1.0.13
...
img_proc_id_node: /opt/ros/foxy/lib/librcpputils.so
img_proc_id_node: /opt/ros/foxy/lib/librcutils.so
img_proc_id_node: /usr/local/lib/libopencv_shape.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_highgui.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_datasets.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_plot.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_text.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_ml.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_phase_unwrapping.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_optflow.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_ximgproc.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_video.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_videoio.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_imgcodecs.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_objdetect.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_calib3d.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_dnn.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_features2d.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_flann.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_photo.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_imgproc.so.4.7.0
img_proc_id_node: /usr/local/lib/libopencv_core.so.4.7.0
img_proc_id_node: CMakeFiles/img_proc_id_node.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable img_proc_id_node"
...
CMakeFiles/img_proc_id_node.dir/depend:
	cd /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg /home/javierfr/Robotics_Cyber_Physical_LAB/src/img_proc_pkg/build/img_proc_pkg/CMakeFiles/img_proc_id_node.dir/DependInfo.cmake --color=$(COLOR)
