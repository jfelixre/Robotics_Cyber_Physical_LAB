...
rclcpp::Node::SharedPtr Robot2VelServer_node = nullptr;
...
void send_vel(const std::shared_ptr<interfaces::srv::RobotVel::Request> request,
          std::shared_ptr<interfaces::srv::RobotVel::Response>      response)
		{
		  ...
		  RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Velocities sent to robot 2:  M1=%f M2=%f M3=%f M4=%f B1=%f B2=%f B3=%f G1=%f",
...
int main(int argc, char **argv)
{
  ...
  Robot2VelServer_node = rclcpp::Node::make_shared("robot2_vel_server");


  rclcpp::Service<interfaces::srv::RobotVel>::SharedPtr service =
    Robot2VelServer_node->create_service<interfaces::srv::RobotVel>("robot2_vel", &send_vel);

  publisher_M = Robot2VelServer_node->create_publisher<interfaces::msg::MotorVelsWArm>("/robot_2/vel_Motors",1);

  RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Ready to send velocities to Robot 2.");

  rclcpp::spin(Robot2VelServer_node);
  rclcpp::shutdown();
}