...
#include <gazebo_plugin_sim/robot2_plugin.hpp>
...
namespace gazebo_plugin_sim
{
	...
	Robot2Plugin::Robot2Plugin()
	: impl_(std::make_unique<Robot2PluginPrivate>())
	{
	...
	void Robot2Plugin::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
	{
		impl_->model_ = _model;
		...
		// Initialize ROS node
  		...
  		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Plugin attached to Robot 2");
    	...
    	impl_->SetVelocityG1(velocityG1);
      	...
      	impl_->updateConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
      		std::bind(&Robot2PluginPrivate::OnUpdate, impl_.get(), std::placeholders::_1));

	}

	//Void set velocity
	void Robot2PluginPrivate::SetVelocityM1(const double &_velM1)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointM1->GetScopedName(),_velM1);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_M1= %f", _velM1);
	}

	void Robot2PluginPrivate::SetVelocityM2(const double &_velM2)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointM2->GetScopedName(),_velM2);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_M2= %f", _velM2);
	}

	void Robot2PluginPrivate::SetVelocityM3(const double &_velM3)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointM3->GetScopedName(),_velM3);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_M3= %f", _velM3);
	}

	void Robot2PluginPrivate::SetVelocityM4(const double &_velM4)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointM4->GetScopedName(),_velM4);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_M4= %f", _velM4);
	}

	void Robot2PluginPrivate::SetVelocityB1(const double &_velB1)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointB1->GetScopedName(),_velB1);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_B1= %f", _velB1);
	}

	void Robot2PluginPrivate::SetVelocityB2(const double &_velB2)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointB2->GetScopedName(),_velB2);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_B2= %f", _velB2);
	}

	void Robot2PluginPrivate::SetVelocityB3(const double &_velB3)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
			Robot2PluginPrivate::jointB3->GetScopedName(),_velB3);
		RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\nSet_Velocity_Robot2_B3= %f", _velB3);
	}

	void Robot2PluginPrivate::SetVelocityG1(const double &_velG1)
	{
		Robot2PluginPrivate::model_->GetJointController()->SetVelocityTarget(
	...
	void Robot2PluginPrivate::OnUpdate(const gazebo::common::UpdateInfo & /*_info*/)
	{
		...
		//Get velocity joints
		velM.vel_m1=Robot2PluginPrivate::jointM1->GetVelocity(0);
		velM.vel_m2=Robot2PluginPrivate::jointM2->GetVelocity(0);
		velM.vel_m3=Robot2PluginPrivate::jointM3->GetVelocity(0);
		velM.vel_m4=Robot2PluginPrivate::jointM4->GetVelocity(0);
		velM.vel_b1=Robot2PluginPrivate::jointB1->GetVelocity(0);
		...
		//Publish ;
		Robot2PluginPrivate::sim_vel_M_->publish(velM);
		Robot2PluginPrivate::LmSw_->publish(LM);
	}
	...
	//Reset
	void Robot2Plugin::Reset()
	{
	  impl_->ros_node_.reset();
	}


	GZ_REGISTER_MODEL_PLUGIN(Robot2Plugin)
}	//namespace gazebo_plugin_sim