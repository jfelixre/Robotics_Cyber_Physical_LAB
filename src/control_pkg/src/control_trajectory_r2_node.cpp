...
class Control_Trajectory_R2_Node : public rclcpp::Node
{
	public:
		Control_Trajectory_R2_Node() : Node("control_trajectory_r2_node")
		{
           subs_trajectory_control = this->create_subscription<interfaces::msg::TrajectoryControl>(
                "/robot_2/trajectory_control", 1, std::bind(&Control_Trajectory_R2_Node::trajectory_control_caller, this,
                std::placeholders::_1));
	...
	public:
		Node_Control_Timer_R2() : Node("node_control_timer_r2")
		{
           ...
           //client_vel = this->create_client<interfaces::srv::PlatformVel>("robot_2/set_platform_vel", rmw_qos_profile_services_default, client_cb_group_);
            publisher_vel = this->create_publisher<interfaces::msg::PlatformVel>("robot_2/set_platform_vel",1);

            timer_ = this->create_wall_timer(
                 100ms, std::bind(&Node_Control_Timer_R2::timer_callback, this));
...
int main(int argc, char * argv[])
{
    ...
    /* myfile.open ("csv/Control_Trajectory_R2_Node.csv");
    ...
    */
  	...
  	//rclcpp::spin(std::make_shared<Control_Trajectory_R2_Node>());
   ...
   // hx[0] = 0.9; // # Posicion inicial en el eje x en metros [m]
	...
	auto node = std::make_shared<Control_Trajectory_R2_Node>();
