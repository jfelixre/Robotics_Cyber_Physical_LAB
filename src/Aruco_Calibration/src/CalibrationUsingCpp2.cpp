...
int main(int argc, char* argv[]) {
    ...
    cv::namedWindow("Working Frame", cv::WINDOW_AUTOSIZE);
  
    int board_width = 8;      // number of inner chessboard cornears 
    int board_height = 5;
    ...
    std::string path = "/home/duvanmarrugo/calibration_data.xml";
    cv::FileStorage fs;
